...
public class Reflections {
	...
	public static Field[] getClassFieldsAndSuperClassFields(Class<? extends Object> obj) {
		// logger.debug("class:{}", obj);
		Field[] fields = obj.getDeclaredFields();
		List<Field> result = Lists.newArrayList(fields);
		// logger.debug("fields size:{}", result.size());
		...
		while (!superClass.equals(Object.class)) {
			...
			ArrayList<Field> superList = Lists.newArrayList(superFields);
